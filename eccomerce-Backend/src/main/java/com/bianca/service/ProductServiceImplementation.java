...
import com.bianca.model.Category;
import com.bianca.model.Product;
import com.bianca.repository.CategoryRepository;
import com.bianca.repository.ProductRepository;
import com.bianca.request.CreateProductRequest;
...
public class ProductServiceImplementation implements ProductService{
	...
	public Product createProduct(CreateProductRequest req) {
		...
		if(secondLevel == null) {
			...
			System.out.println(secondLevelCategory.getName());
